...
-- Minimap display
Config.EnableMinimapOnFoot = true  -- show minimap while player is on foot (not in a vehicle)

-- Redline threshold
Config.RedlineThreshold = 85

-- Seatbelt
Config.EnableSeatbelt     = true   -- set false to disable the seatbelt system entirely
...
-- Default components visible for new players
...
Config.MenuOptions = {
    ...
    job         = true,
    cash        = true,
    bank        = false,  -- lock bank toggle in /hud
    minimap     = true,
    streetclock = true,
    health      = true,
    armor       = true,
...
-- UI colours — injected into CSS custom properties at runtime
Config.Colors = {
